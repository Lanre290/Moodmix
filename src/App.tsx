  ...
  const handleGeneratePlaylist = async () => {
    try {
      ...
      const prompt = `Analyze the user's mood and feelings along with their top artists and songs.
                      ...
                      Return only keywords for a Spotify search query that aligns with the user's mood, make it only one string while priortizing the order of the keywords according to their relevance, include only necessary keywords without any extra word. e.g:("Polo G", "Gunna", "Juice WRLD", "YNW Melly", "melodic rap", "trap", "afrobeats", "Omah Lay", "modern rock", "positive vibes", "up-tempo")`;
