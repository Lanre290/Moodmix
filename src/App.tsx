  ...
  const handleGeneratePlaylist = async () => {
    try {
      ...
      const prompt = `Analyze the user's mood and feelings along with their top artists and songs.
                      ...
                      Return only keywords for a Spotify search query that aligns with the user's mood, make it brief(only one string but not too short and not long) while priortizing the order of the keywords according to their relevance based on user top artist and song, if user input differs from user's top artist and songs priortize finding new artist and songs related to user's input, include only necessary keywords without any extra word. e.g:("Polo G", "Gunna", "Juice WRLD", "YNW Melly", "melodic rap", "trap", "afrobeats", "Omah Lay", "modern rock", "positive vibes", "up-tempo")`;
